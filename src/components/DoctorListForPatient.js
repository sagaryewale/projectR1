...
class DoctorListForPatient extends Component {
  ...
  getDoctorList = () => {
    ...
    AppointmentService.getDoctorsBySpecializationAndCity(
      this.props.location.state.specialization,
      ...
      <>
        <div className="container my-4">
          <button
            ...
            onClick={() => {
              this.props.history.push("/specialization-list-by-city");
            }}
          >
            Go Back
          </button>
          <h3 className="fw-bold text-center">
            Available {this.props.location.state.specialization}s in{" "}
            {this.props.location.state.city}
          </h3>
